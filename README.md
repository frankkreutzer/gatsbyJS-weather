...
<h1 align="center">
  jdebettencourt's draft gatsby-starter-weather (from Gatsby's hello-world starter at first...)
</h1>
...
Adjusted instructions for draft gatsy-starter-weather

1.  **Create a Gatsby site.**

    Use the Gatsby CLI to create a new site, specifying the current draft of the gatsby-starter-weather.
...
1.  **Start developing.**
    ...
    Navigate into your new site’s directory and start it up. Below shows --host and --port options useful at codeanywhere.com.
...
1.  **Open the source code and start editing!**
    ...
    Your site is now running at `https://0.0.0.0:3000`!
